...
from Models.PlanesPruebaModel import PlanesPruebaModel
from Views.PlanesPruebaView import PlanesPruebaView

from Controllers.CasosPruebaController import CasosPruebaController


class PlanesPruebaController:
    def __init__(self, root):
        self.root = root

        self.model = PlanesPruebaModel()

        self.view = PlanesPruebaView(self.root)
    ...
    def save_button_clicked(self):
        ...
        :return:
        """
        CasosPruebaController(self.root)
